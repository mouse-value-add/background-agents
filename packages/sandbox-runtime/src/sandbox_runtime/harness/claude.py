...
CLAUDE_CAPABILITIES = HarnessCapabilities(
    model_families=("anthropic",),
    provider_auth={"anthropic": ("api_key", "provider_account")},
    # ThinkingBlock is available; timeline rendering is v2 (dropped for now).
